...
const nam:number = ammm.filter(i=>i<0).reduce((acc,i)=>(acc += i*1),0);
  ...
  return (
    ...
    <div className={classes.root}>
      ...
      <Paper variant="outlined" className="Income"><br/>INCOME  <br/>
        <span style={{fontSize:"30px",color:"rgb(11, 151, 11)"}}>
          ${pam}
        </span>
      </Paper>
      
      <Paper variant="outlined" className="Expenses"><br/>EXPENSES <br/>
        <span style={{fontSize:"30px",color:"rgb(218, 46, 33"}}>
           ${nam}
        </span>
      </Paper>
